...
//		dao.memberInsert(member.getMemId(), member.getMemPw(), member.getMemMail(), member.getMemPhone1(), member.getMemPhone2(), member.getMemPhone3());
	...
	@Override
	public void macroRegister(Macro macro) {
		System.out.println("marcoRegister()");
		System.out.println("macro1 : " + macro.getMacro01());
		System.out.println("macro2 : " + macro.getMacro02());
		System.out.println("macro3 : " + macro.getMacro03());
		System.out.println("macro4 : " + macro.getMacro04());
		System.out.println("macro5 : " + macro.getMacro05());

		dao.macroInsert(macro);
	}
